...
const ProcessSection = ({
  ...
  return (
    <Box {...sectionWrapper} as="section" id="process_section" style={{marginBottom: '60px'}}>
      <Container noGutter mobileGutter width="1200px">
        ...
        <Box {...learningRow}>
          <Box {...learningContentArea}>
            ...
            <Text
              {...learningDescription}
              content="If you have a new project or just interested in getting to know us, we would love to hear from you."
            />
            {/* <Text
              {...learningDescription}
