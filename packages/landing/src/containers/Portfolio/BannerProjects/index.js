...
import PersonImage from 'common/assets/image/portfolio/yellow-workstation.jpg';
...
const BannerSection = ({
  ...
  return (
    <BannerWrapper id="banner_section" className="diagonal">
    <div id="bg"></div>   

      <Container noGutter mobileGutter width="1200px">
        <Box {...row}>
          <Box {...contentArea}>
            <Heading content="See Our Past Work." {...greetingStyle} />
            <Heading content="Nerd Stack" {...nameStyle} />
            <Heading as='h1' content="Projects" {...designationStyle} />
            {/* <Box {...roleWrapper}>
              <Icon
          ...
          <Box {...imageArea} className="image_area cloud-overlay">
            <Image style={{height:'100%', width:'100%'}} src={PersonImage} alt={PersonImage} />
          </Box>
        </Box>
      </Container>
    </BannerWrapper>
