    ...
    <Box {...sectionWrapper} as="section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          ...
          <Text
            {...secDescription}
            content="If you have a website or mobile app idea in mind or you need some advice about product design, feel free to contact us. Currently our time books quickly, so the sooner you write, the better it is for both of us."
          />
        </Box>
        <Box {...replyWrapper}>
          <ActiveStatus>
