...
/* agency global style */
const AgGlobalStyle = createGlobalStyle`
  body {
...
AgGlobalStyle.displayName = 'AgGlobalStyle';
TopSectionWrapper.displayName = 'TopSectionWrapper';

export { AgGlobalStyle, TopSectionWrapper };
