...
import PersonImage from 'common/assets/image/portfolio/pattern.jpg';
  ...
  return (
    ...
    <div id="bg"></div>   
      ...
      <Container noGutter mobileGutter width="1200px">
        <Box {...row}>
          <Box {...contentArea}>
            <Heading content="Hello, Welcome." {...greetingStyle} />
            <Heading content="Nerd Stack" {...nameStyle} />
            <Heading as='h1' content="About Us" {...designationStyle} />
            {/* <Box {...roleWrapper}>
              <Icon
