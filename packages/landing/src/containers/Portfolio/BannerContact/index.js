...
import PersonImage from 'common/assets/image/portfolio/stripes.jpg';
  ...
  return (
    ...
    <div id="bg"></div>   
      ...
      <Container noGutter mobileGutter width="1200px">
        <Box {...row}>
          <Box {...contentArea}>
            <Heading content="Let Have a Chat." {...greetingStyle} />
            <Heading content="Nerd Stack" {...nameStyle} />
            <Heading as='h1' content="Contact Us" {...designationStyle} />
            {/* <Box {...roleWrapper}>
              <Icon
