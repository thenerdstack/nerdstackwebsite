  ...
  return (
    <Box {...sectionWrapper} as="section">
      <Container noGutter mobileGutter width="1200px">
        <CallToActionWrapper>
          <Box {...textArea}>
            <Heading content="Check Out Our Blog!" {...title} />
            <Text
              content="The place to find the latest industry trends, news and information to keep you at the top your tech game."
              {...description}
            />
          </Box>
          <Box {...buttonArea}>
