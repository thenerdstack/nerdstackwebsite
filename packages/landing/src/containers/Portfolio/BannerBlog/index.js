...
import PersonImage from 'common/assets/image/portfolio/green-brick.jpg';
  ...
  return (
    ...
    <div id="bg"></div>   
      ...
      <Container noGutter mobileGutter width="1200px">
        <Box {...row}>
          <Box {...contentArea}>
            <Heading content="Read Our Thoughts." {...greetingStyle} />
            <Heading content="Nerd Stack" {...nameStyle} />
            <Heading as='h1' content="Blog" {...designationStyle} />
            {/* <Box {...roleWrapper}>
              <Icon
