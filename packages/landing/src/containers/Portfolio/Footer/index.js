        ...
        <Box {...row}>
          <Box {...col}>
            <Heading
              ...
              {...titleStyle}
            />
              <a href="mailto:David@thenerdstack.com" target="_blank" className='portfolio_button'>
                <Heading as="h3" content="LET'S TALK!" {...linkStyle} className='portfolio_button' />
              </a>
          </Box>
          <Box {...col}>
            <Image
        ...
        <Box {...row}>
          <Box {...col}>
            ...
            <Link href="/">
              <a>
                {' '}
                <Text as="span" content=" Nerd Stack, LLC. " {...copyrightStyle} />
              </a>
            </Link>
          </Box>
          {/* <Box {...col} {...flexBox}>
            ...
            <Box {...contactItem}>
              ...
              <Text content="303-5" {...contactInfo} />
            </Box>
          </Box> */}
        </Box>
