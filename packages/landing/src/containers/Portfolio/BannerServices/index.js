...
import PersonImage from 'common/assets/image/portfolio/redgeometry.jpg';
  ...
  return (
    ...
    <div id="bg"></div>   
      ...
      <Container noGutter mobileGutter width="1200px">
        <Box {...row}>
          <Box {...contentArea}>
            <Heading content="What We Do." {...greetingStyle} />
            <Heading content="Nerd Stack" {...nameStyle} />
            <Heading as='h1' content="Services" {...designationStyle} />
            {/* <Box {...roleWrapper}>
              <Icon
